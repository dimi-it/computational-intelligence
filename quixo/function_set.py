...
class FunctionSet:
    ...
    @classmethod
    def get_random_function(cls, rnd: Random, to_exclude: None | Function = None, inputs: None | int = None, outputs: None | int = None):
        set = cls._set
    ...
    @classmethod
    def get_random_action_function(cls, rnd: Random, to_exclude: None | Function = None):
